...
public class Commands extends Configuration {
    ...
    public static String GUILD_USER_LIST_NAME = "lista";
    public static String GUILD_USER_LIST_DESCRIPTION = "lista wszystkich gildii";
    public static String GUILD_USER_LIST_USAGE = "/g lista";
    public static String GUILD_USER_LIST_PERMISSION = "revoguild.commands.guild.list";
    public static List<String> GUILD_USER_LIST_ALIASES = Arrays.asList("list", "top");
    ...
    public static String GUILD_USER_SETHOME_NAME = "ustawdom";
    public static String GUILD_USER_SETHOME_DESCRIPTION = "ustawianie domu gildii";
    public static String GUILD_USER_SETHOME_USAGE = "/g ustawdom";
    public static String GUILD_USER_SETHOME_PERMISSION = "revoguild.commands.guild.sethome";
    public static List<String> GUILD_USER_SETHOME_ALIASES = Arrays.asList("sethome", "ustawbaze");
    ...
    public static String TOP_DESCRIPTION = "top 10 graczy";
